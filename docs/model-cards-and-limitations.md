...
> **Important:** SDK metrics are offered for general wellness and informational
> purposes only. SDK metrics have not been cleared by the FDA and may not be
> used for medical diagnosis or treatment.

The SDK exposes one language-agnostic metrics payload across platforms. This
overview summarizes the documented capability surface and calls out validation
gaps directly. See the [payload schema](data-types.md) for field names and
wire types.
