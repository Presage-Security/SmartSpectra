---
title: Quick Start
description: Get started with the SmartSpectra Android SDK — Kotlin SDK via Maven, min SDK 28.
---
...
- [Option 1: API Key](docs/OPTION_1_API_KEY.md)
- [Option 2: OAuth](docs/OPTION_2_OAUTH.md)
...
Use [Option 1: API Key](docs/OPTION_1_API_KEY.md) for the fastest manual setup.

Use [Option 2: OAuth](docs/OPTION_2_OAUTH.md) if you need OAuth.
